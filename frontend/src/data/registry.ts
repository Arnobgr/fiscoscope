...
export interface Entry {
  slug: string; apiId: string; theme: ThemeId; unit: Unit; polarity: Polarity;
  title: string; explainer: string; adapter: Adapter;
}

const e = (slug: string, theme: ThemeId, unit: Unit, polarity: Polarity, title: string, explainer: string, adapter: Adapter): Entry =>
  ({ slug, apiId: `kpi_${slug}`, theme, unit, polarity, title, explainer, adapter });

export const REGISTRY: Entry[] = [
  e("overhead_rate", "efficacite", "percent", "higher_bad", "Coût administratif",
  ...
  e("friction_ratio", "efficacite", "percent", "higher_bad", "Ratio de friction",
  ...
  e("productive_spend", "efficacite", "percent", "higher_good", "Part des dépenses productives",
  ...
  e("wage_ratio", "efficacite", "percent", "higher_bad", "Masse salariale public / privé",
  ...
  e("sustainability", "soutenabilite", "percent", "higher_good", "Déficit public & dette",
  ...
  e("debt_service", "soutenabilite", "percent", "higher_bad", "Charge de la dette",
  ...
  e("pension_investment", "soutenabilite", "ratio", "higher_bad", "Protection sociale vs investissement",
  ...
  e("outcomes", "depenses", "mixed", "neutral", "Dépenses de santé vs espérance de vie",
  ...
  e("tax_expenditure", "depenses", "eur_bn", "higher_bad", "Dépenses fiscales (niches)",
  ...
  e("monthly_execution", "depenses", "eur", "neutral", "Exécution budgétaire mensuelle",
...
export function buildView(slug: string, raw: unknown): KpiView {
  ...
  const { slug: s, title, explainer, unit, polarity } = entry;
  return entry.adapter(raw, { slug: s, title, explainer, unit, polarity });
}
