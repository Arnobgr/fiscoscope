  ...
  return (
    <div className="app-shell">
      ...
      <footer className="app-footer">
        ...
        <nav className="footer-links" aria-label="Liens de l’auteur">
          <span className="footer-links__by">
            Réalisé par{" "}
            <a className="footer-links__name" href="https://arno.sh" target="_blank" rel="noopener noreferrer">Arno Beauger</a>
          </span>
